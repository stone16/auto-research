...
Q12 lock: `q12.cog2` failure = Reddit discovery-only calls (`reddit-scount.md:145-162`), not analysis/community fit (`reddit-scount.md:108-139`); `q12.cog3` failure = raw X shortcuts (`openclaw-marketing.md:7500-7507`), not X metadata/Gateway policy (`openclaw-marketing.md:7392-7422`, `openclaw-marketing.md:122-158`).
